...
public class Teste
{
    ...
    public void testarVeiculo() {
        ...
        assertEquals(0.045,v1.custoMedioKm(1.5),0);
    ...
    */
    ...
    public void testarProduto() {
        ...
        //Test toString dá erro
        //System.out.println( " o2 stock "+ o2.getStock()+ " p stock "+p.getStock());
        //assertTrue(o2.toString().contains(String.valueOf(p.getStock())));
    }
    

    /**
     * Testes da classe CronometroDS
     */
    ...
    public void testarCronometro() {
        ...
        c.parar();
        assertEquals("1",c.primeiraParagem().split(":")[1].split("'")[0]);
