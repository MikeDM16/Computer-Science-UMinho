 ...
 * @author  jfc
 */
public class JCalculadora extends javax.swing.JFrame implements java.util.Observer{
    ...
    public JCalculadora() {
        ...
        /** regista-se como observador da Calculadora para poder actualizar o ecran */
    ...
    private void initComponents() {
        ...
        screen.setFont(new java.awt.Font("Default", 1, 18));
    ...
    private void opr_press(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opr_press
        ...
        this.calc.processa(evt.getActionCommand().charAt(0));
    ...
    private void digit_press(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_digit_press
        // Add your handling code here:
        this.calc.processa(Integer.parseInt(evt.getActionCommand()));
