...
--
-- Criacao de um procedimento para nos indicar os 3 melhores clientes de uma loja da "Sakila".
DELIMITER $$
...
BEGIN
	...
	WHILE DataInicio  <= DataFim DO
		INSERT INTO Calendar	
			...
			VALUES(DataInicio,DAYNAME(DataInicio),DAYOFMONTH(DataInicio),WEEK(DataInicio),QUARTER(DataInicio));
...
BEGIN
	...
	WHILE DataInicio  <= DataFim DO
		...
		INSERT INTO Calendar	
			...
			VALUES(DataInicio,DAYNAME(DataInicio),DAYOFMONTH(DataInicio),WEEK(DataInicio),
